...
var rand;
var resultObj = {}; // we use this to verify that the correct object is indeed returned
var randomSpy = jasmine.createSpy('random').and.returnValue(resultObj);
var exRandomSpy = jasmine.createSpy('exRandom').and.returnValue([2,1,0]);
...
describe('database Randomizer', function(){
    ...
    describe(': exRandom', function(){
        ...
        it('should re-randomize when exceeding length', function(){
            ...
            rand.exRandom(3, 'seed');
            rand.exRandom(3, 'seed');
            expect(exRandomSpy.calls.count()).toBe(2);
        });
