import './mixerModule';
import '../randomize/randomizeModuleMock';
...
describe('Mixer', function(){
    ...
    describe(': mixerSequential', function(){
        ...
        var mix2 = {mixer:2};
        var mix3 = {mixer:3};
        var mixerSpy = jasmine.createSpy('mixer').and.callFake(function(a){
            if (a == mix1){
                return ['a','b'];
            }
            if (a == mix2){
    ...
    describe(': branching', function(){
        ...
        describe('mixerCondition', function(){
            ...
            it('should support the whole condition as a function', function(){
                var opSpy = jasmine.createSpy('operator').and.callFake(function(){return true;});
